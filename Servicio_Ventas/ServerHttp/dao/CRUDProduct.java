...
public class CRUDProduct {
    ...
    public static void main(String[] args) {
        ...
        crudProduct.createProducto("1", "nameProducto", "detailProducto", "priceProducto", "stockProducto");
        crudProduct.createProducto("2", "nameProducto", "detailProducto", "priceProducto", "stockProducto");

        Producto producto = crudProduct.readProducto("1");
        System.out.println(producto);
        crudProduct.deleteProducto("1");
        crudProduct.updateProducto("2", "nameeeeeee", "detailProducto", "priceProducto", "stockProducto");
    }
}
